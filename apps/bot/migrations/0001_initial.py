# Generated by Django 3.2.4 on 2021-07-23 16:37
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('title', models.CharField(default='Edition 1', max_length=100)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('number', models.IntegerField(auto_created=True, unique=True)),
                ('title', models.CharField(default='Nvl 0. Legionário', max_length=100)),
                ('description', models.TextField(default='Description....')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('id_user', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='bot.profile')),
            ],
        ),
        migrations.CreateModel(
            name='Ranking',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('prestige', models.BooleanField(default=False)),
                ('prestige_level', models.IntegerField(null=True)),
                ('updated', models.DateTimeField(auto_now=True)),
                ('created', models.DateTimeField(auto_now_add=True)),
                ('id_user', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='bot.profile')),
                ('level', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='bot.level')),
            ],
        ),
        migrations.CreateModel(
            name='DoneList',
